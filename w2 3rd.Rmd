...
Compare and Select a Model with the Min Error
```{r}
accuracy(mean_forecast)
accuracy(rwf_forecast)
accuracy(naive_forecast)
...
```
#We're using MAPE to figure out the top forecast model. After sizing them up, the Naive and SNaive models come out ahead with a MAPE of 36.12719.
